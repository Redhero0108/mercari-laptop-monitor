...
const seriesCases = [
  ...
  ['レノボ T14 Gen 3', 'thinkpad-t14'],
  ['ThinkPad T14s', 'thinkpad-t14s'],
  ['ThinkPad X13', 'thinkpad-x13'],
  ['レノボ X13 Gen2 Ryzen7', 'thinkpad-x13'],
  ...
  ['ダイナブック G83/KV', 'dynabook-g83'],
  ['Fujitsu LIFEBOOK U9312', 'fujitsu-lifebook-u9312'],
  ['富士通 ライフブック U9312', 'fujitsu-lifebook-u9312'],
  ...
  ['DELL プレシジョン 5570', 'dell-precision'],
  ...
  ['NEC バーサプロ UltraLite タイプVN Core i5', 'nec-versapro-premium'],
